...
const HeroSection = () => {
  ...
  return (
    <section className="relative  py-8 sm:py-12 px-4 sm:px-6 md:px-16 overflow-hidden flex items-center">
      ...
      {/* Hero Content */}
      <div className="relative max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6 md:gap-10 z-10">
        {/* Left Content */}
        <div className="md:w-1/2 text-center md:text-left">
          ...
          <div className="mt-6 flex flex-col sm:flex-row justify-center md:justify-start gap-4">
            <button className="px-6 py-3 border border-white bg-[#F06543] text-white font-semibold rounded-md hover:bg-white hover:text-[#F06543] transition duration-300">
              Start Your Journey
            </button>
            <button className="px-6 py-3 border border-white hover:border-[#F06543] text-white hover:bg-white hover:text-[#F06543] font-semibold rounded-md transition duration-300">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 mt-4">
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  ...
                  <div className="group relative">
                    <MapPin className="absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-gray-400 group-focus-within:text-blue-500 transition-colors" />
                    <input
                      type="text"
                      name="city"
                      value={form.city}
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div className="group relative">
                    <MapPin className="absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-gray-400 group-focus-within:text-purple-500 transition-colors" />
                    <input
                      type="text"
                      name="destination"
                  ...
                  <div className="group relative">
                    <Calendar className="absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-gray-400 group-focus-within:text-purple-500 transition-colors" />
                    <input
                      type="date"
                      name="travelDate"
                  ...
                  <div className="flex gap-2">
                    <div className="relative flex-1">
                      <Clock className="absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-gray-400 group-focus-within:text-purple-500 transition-colors" />
                      <input
                        type="number"
                        name="travelDays"
                        placeholder="Days"
                  ...
                  <div className="group relative">
                    <Route className="absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-gray-400 group-focus-within:text-purple-500 transition-colors" />
                    <select
                      name="leadType"
                      value={form.leadType}
                      onChange={handleChange}
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                  ...
                  <div className="group">
                    ...
                    <div className="relative">
                      <Baby className="absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-gray-400 group-focus-within:text-green-500 transition-colors" />
                      <input
                        type="number"
                        name="infant"
