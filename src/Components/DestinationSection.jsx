...
export default function DestinationsSection() {
  ...
  return (
    <section className="py-16 bg-white text-center">
      <h2 className="text-3xl font-bold text-gray-800">Find Your Next Adventure</h2>
      <p className="text-gray-600 max-w-xl mx-auto mt-4">
        Whether you're looking for mountains, beaches, heritage, or peace—Begin Yatra brings the best destinations to your fingertips.
      </p>
        ...
        {destinations.map((item, index) => (
          ...
          >
            ...
            <div className="p-4 text-left">
              ...
              <a
                href="#"
                className="text-blue-500 mt-3 inline-block text-sm font-medium hover:underline"
              >
                Learn More →
              </a>
            </div>
