...
const PricingCard = ({ plan, features, buttonColor }) => (
  <div className="w-full md:w-1/3 p-4 flex flex-col h-full bg-white rounded-lg shadow-md">
    <div
      className={`${buttonColor} text-white p-4 rounded-lg text-center mb-4`}>
    ...
    <button
      className={`mt-auto w-full ${buttonColor} text-white p-3 rounded hover:opacity-90 transition-opacity mt-4`}>
      Purchase Now
    </button>
  </div>
);
...
const AdvertiseWithUs = () => {
  ...
  const coreFeatures = [
    ...
    { key: "customerLeads", label: "Customer Packages from Posted Offers" },
    { key: "leadRewardPoints", label: "Package Reward Points" },
    {
      key: "customWebsiteDesign",
      label: "Custom Website Design",
      description:
        "Includes domains like .co.in and .in (e.g., www.yourcompany.in)",
    },
    ...
    {
      key: "quarterlyPerformanceReview",
      label: "Quarterly Performance Review",
    },
  ...
  const testimonials = [
    {
      text: "The Platinum package transformed our lead generation!",
      author: "Ravi Kumar",
    },
    {
      text: "The Star plan's features exceeded our expectations and boosted our brand!",
      author: "Sneha Gupta",
    },
    {
      text: "Excellent support and visibility. Highly recommend!",
      author: "Priya Sharma",
    },
  ];
  ...
  const DisplayAdsContent = () => (
    <div className="text-center p-8 bg-gray-50 rounded-lg">
      ...
      <p className="text-lg text-[#333]">
        Reach a wider audience with our premium display ad placements across our
        platform.
      </p>
      <Link
        to="/contact"
        className="mt-4 inline-block bg-[#20B2AA] text-white p-3 rounded hover:bg-[#1F9A93] transition-colors">
  ...
  const ExtraServicesContent = () => (
    <div className="text-center p-8 bg-gray-50 rounded-lg">
      <h3 className="text-2xl font-semibold text-[#1E90FF] mb-4">
        Additional Services to Boost Your Business
      </h3>
      <p className="text-lg text-[#333]">
        Explore our range of supplementary services like SEO optimization,
  ...
  return (
    <div
      ...
      style={{
        backgroundImage:
          "url('https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?fit=crop&w=1500&q=80')",
        ...
        {activeTab === "corePlans" && (
          <div className="flex flex-col md:flex-row md:items-stretch gap-6">
            ...
            <div className="w-full md:w-1/3 bg-gray-50 p-6 rounded-lg shadow-inner flex flex-col h-full">
              <h3 className="text-2xl font-semibold text-center text-[#1E90FF] mb-4">
                Our Core Features
              </h3>
